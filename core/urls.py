...
from app.views.click_api import *
from app.views.payme_endpoint import *
...
urlpatterns = [
    ...
    # click-api
    path("click/prepare", click_prepare),
    path("click/complete", click_complete),

    # payme endpoint
    path("payme/endpoint", payme_endpoint),
