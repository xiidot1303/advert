...
def vacancies(update, context):
    ...
    update.message.reply_text(get_word('all vacancies', update), 
        reply_markup=ReplyKeyboardMarkup(keyboard=[[get_word('create vacancy', update)], [get_word('back', update)]], resize_keyboard=True))
